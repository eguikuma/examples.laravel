...
class UserControllerTest extends TestCase
{
    ...
    public function すべてのユーザーを取得できること(): void
    {
        ...
        $response = $this->getJson('/api/snippets/users');
    ...
    public function 特定のユーザーを取得できること(): void
    {
        ...
        $response = $this->getJson("/api/snippets/users/{$user->id}");
    ...
    {
        $response = $this->getJson('/api/snippets/users/9999');
    ...
    public function ユーザーを作成できること(): void
    {
        ...
        $response = $this->postJson('/api/snippets/users', $expected);
    ...
    {
        $response = $this->postJson('/api/snippets/users', ['name' => $name]);
    ...
    public function ユーザーを更新できること(): void
    {
        ...
        $response = $this->putJson("/api/snippets/users/{$user->id}", $expected);
    ...
    {
        $response = $this->putJson('/api/snippets/users/9999', ['name' => $this->faker->name]);
    ...
    public function バリデーションエラーの場合はユーザー更新が失敗すること(?string $name): void
    {
        ...
        $response = $this->putJson("/api/snippets/users/{$user->id}", ['name' => $name]);
    ...
    public function ユーザーを削除できること(): void
    {
        ...
        $response = $this->deleteJson("/api/snippets/users/{$user->id}");
    ...
    {
        $response = $this->deleteJson('/api/snippets/users/9999');
